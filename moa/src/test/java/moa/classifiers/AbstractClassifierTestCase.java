...
public abstract class AbstractClassifierTestCase
   ...
   */
  protected InspectionData[] inspect(Instances data, int[] inspectionPoints, ClassificationPerformanceEvaluator evaluator, Classifier scheme) {
   ...
   * @return		the setups
   */
  protected abstract ClassificationPerformanceEvaluator[] getRegressionEvaluatorSetups();
  ...
  public void testRegression() {
    ...
    int[]					cindices;
    Classifier[]				setups;
    ClassificationPerformanceEvaluator[]	evals;
    int[][]					points;
    Classifier					current;
    String[]					output;
    TmpFile[]					outputFiles;
