...
/**
 * Ancestor that defines a setting to test a classifier several times
 * with different parameters using this predefined same setting.
 * 
...
public abstract class AbstractMultipleClassifierTestCase
   ...
   */
  public AbstractMultipleClassifierTestCase(String name, int numberTests) {
    super(name);
